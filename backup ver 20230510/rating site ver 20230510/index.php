...
<div class="mb-3">
  ...
  <input id="url" type="hidden" class="form-control" name="url" value="https://web-final-crud-webdesignghs2022-1.webdesignghs2022.repl.co" name="url" required autofocus>
  <input id="uid" type="hidden" class="form-control" name="uid" value="100" required autofocus name="uid">
  <input id="access" type="hidden" class="form-control" name="access" value="1" required autofocus name="access">
		<div class="invalid-feedback">
			Email is invalid
	 </div>
